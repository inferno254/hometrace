...
import { Phone, ChevronLeft, MapPinned, Image as ImageIcon } from 'lucide-react'
            ...
            <div className="grid gap-0 md:grid-cols-2">
                ...
                {q.data.image_urls && q.data.image_urls[0] ? (
                  <>
                    ...
                    >
                      ...
                      {q.data.image_urls.length} photo{q.data.image_urls.length > 1 ? 's' : ''}
                    </button>
                  </>
                ) : (
              ...
              <div className="flex flex-col justify-center gap-4 p-6 md:p-8">
                ...
                <div className="flex flex-wrap gap-2 text-xs capitalize text-zinc-300">
                  ...
                  {q.data.bathrooms != null && <span className="rounded-full bg-white/10 px-2 py-1">{q.data.bathrooms} bath</span>}
                ...
                <div className="flex flex-col gap-2 sm:flex-row pt-2">
                  ...
                  {env.whatsappUrl && env.whatsappUrl !== '#' && (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex flex-1 items-center justify-center rounded-xl border border-white/15 px-4 py-3 text-sm font-semibold text-white hover:bg-white/5 transition-colors"
                    >
                      WhatsApp us
                    </a>
                  )}
