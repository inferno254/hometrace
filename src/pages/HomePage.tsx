  ...
  return (
    <>
      <section className="relative overflow-hidden border-b border-white/10">
        <div
          className="pointer-events-none absolute inset-0 bg-hero-grid bg-grid-size opacity-35"
          aria-hidden
        />
        <div className="relative mx-auto flex max-w-6xl flex-col gap-10 px-4 py-16 md:flex-row md:items-center md:py-24">
          <div className="flex-1 space-y-6">
            ...
            <div className="flex flex-wrap gap-3">
              <Link
                to="/browse"
                className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-cyan-500 to-violet-500 px-5 py-3 text-sm font-semibold text-trace-dusk shadow-lg shadow-cyan-500/25 hover:opacity-95"
              >
          ...
          <div className="glass-card flex-1 p-6 md:max-w-md">
      ...
      <section className="mx-auto max-w-6xl px-4 py-14">
        ...
        {configured && q.isLoading && (
          <p className="text-zinc-500 text-center py-12">Tracing listings...</p>
        )}
        {configured && q.error && (
